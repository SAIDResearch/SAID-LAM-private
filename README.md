...
model-index:
  - name: SAID-LAM-v1
    results:
      # MTEB LongEmbed (SAID-LAM-v1)
      - task:
          type: retrieval
          name: LEMBNeedleRetrieval
        dataset:
          name: mteb/LEMBNeedleRetrieval
          type: mteb
          split: test_256
      ...
      - task:
        ...
        dataset:
          name: mteb/LEMBPasskeyRetrieval
          type: mteb
          split: test_256
      ...
      - task:
        ...
        dataset:
          name: mteb/LEMBSummScreenFDRetrieval
          type: mteb
          split: validation
          revision: 6e346642246bfb4928c560ee08640dc84d074e8c
        metrics:
      ...
      - task:
        ...
        dataset:
          name: mteb/LEMBWikimQARetrieval
          type: mteb
          split: test
          revision: 6e346642246bfb4928c560ee08640dc84d074e8c
        metrics:
